...
public class StoreDao {
	...
	static {
		...
		list.add(new Store(2, "브루클린", "논현역", "02-545-0718", "양식", "김철수", true, 2, 0));
		list.add(new Store(3, "쉐이크쉑", "강남역", "02-553-5576", "양식", "김영희", true, 3, 0));
		list.add(new Store(4, "바스버거", "신논현역", "02-568-6654", "양식", "한강", true, 5, 0));

		list.add(new Store(5, "중화루", "논현역", "02-2143-1293", "중식", "최진영", true, 5, 0));
		list.add(new Store(6, "금장각", "논현역", "02-1234-5678", "중식", "향돌", true, 2, 0));
		list.add(new Store(7, "화양루", "강남역", "02-2345-6789", "중식", "육성재", true, 1, 0));
		list.add(new Store(8, "중식루", "신논현역", "02-3456-7890", "중식", "나재민", true, 4, 0));

		list.add(new Store(9, "우오하나", "논현역", "010-7569-1487", "일식", "현승희", true, 4, 0));
		list.add(new Store(10, "은행골", "논현역", "02-592-4988", "일식", "이예진", true, 3, 0));
		list.add(new Store(11, "청담이상", "강남역", "02-517-1155", "일식", "아린", true, 5, 0));
		list.add(new Store(12, "스시루", "신논현역", "02-565-3355", "일식", "주학년", true, 1, 0));

		list.add(new Store(13, "호족반", "논현역", "070-8899-3696", "한식", "서은광", true, 5, 0));
		list.add(new Store(14, "역삼갈비", "논현역", "02-557-9769", "한식", "김성대", true, 4, 0));
